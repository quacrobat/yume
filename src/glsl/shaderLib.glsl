 ...
 * References:
 *
 * random, noise and fbm: 1D, 2D & 3D Value Noise by Morgan McGuire @morgan3d, http://graphicscodex.com
 */
 ...
 */
 ...
 /* 
  * Calculates a one-dimensional noise.
  *
  * @param {float} x - The input parameter.
  * 
...
float noise( in float x ) {
 ...
 /* 
  * Calculates a two-dimensional noise.
  *
...
float noise( in vec2 x ) {
 ...
 /* 
  * Calculates a three-dimensional noise.
  *
